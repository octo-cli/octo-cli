...
var FlagHelps = map[string]map[string]map[string]string{
	...
	"repos": {
		...
		"upload-release-asset": {
			"content-length": "Size of the asset in bytes. Most libraries will calculate the header automatically",
			"content-type":   "Media Type of the asset. For a list of media types, see https://www.iana.org/assignments/media-types/media-types.xhtml",
