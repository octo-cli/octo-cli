...
Octo-cli is a command line client for GitHub's REST API. It is intended to make it easier to use GitHub's api from
 shell scripts. 
...
`gh` has a more refined user interface and demands at least 80% less typing in day to day use. Octo-cli wants to
 ...
 curl route, octo-cli will help you compose curl commands.
