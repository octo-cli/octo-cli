...
var FlagHelps = map[string]map[string]map[string]string{
	...
	"enterprise-admin": {
		"delete-scim-group-from-enterprise":                 {"scim_group_id": "Identifier generated by the GitHub SCIM endpoint."},
		"delete-user-from-enterprise":                       {"scim_user_id": "Identifier generated by the GitHub SCIM endpoint."},
		"get-provisioning-information-for-enterprise-group": {"scim_group_id": "Identifier generated by the GitHub SCIM endpoint."},
		"get-provisioning-information-for-enterprise-user":  {"scim_user_id": "Identifier generated by the GitHub SCIM endpoint."},
	...
	"users": {
		...
		"create-gpg-key-for-authenticated": {"armored_public_key": "Your GPG key, generated in ASCII-armored format. See \"[Generating a new GPG key](https://docs.github.com/articles/generating-a-new-gpg-key/)\" for help creating a GPG key."},
