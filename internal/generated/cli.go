...
var CmdHelps = map[string]map[string]string{
	...
	"emojis": {"get": "Get - https://developer.github.com/v3/emojis/#emojis"},
	"gists": {
	...
	"meta": {"get": "Get - https://developer.github.com/v3/meta/#meta"},
	"migrations": {
	...
	"rate-limit": {"get": "Get your current rate limit status - https://developer.github.com/v3/rate_limit/#get-your-current-rate-limit-status"},
	"reactions": {
...
var FlagHelps = map[string]map[string]map[string]string{
	"actions": {
		...
		"download-workflow-job-logs":          {"repo": "repository in OWNER/REPO form"},
		...
		"get-workflow-job":                    {"repo": "repository in OWNER/REPO form"},
	...
	"issues": {
		...
		"check-assignee": {"repo": "repository in OWNER/REPO form"},
		"create": {
	...
	"migrations": {
		...
		"get-import-progress":               {"repo": "repository in OWNER/REPO form"},
	...
	"orgs": {
		"add-or-update-membership": {"role": "The role to give the user in the organization. Can be one of:  \n\\* `admin` - The user will become an owner of the organization.  \n\\* `member` - The user will become a non-owner member of the organization."},
		"create-hook": {
		...
		"update-membership": {"state": "The state that the membership should be in. Only `\"active\"` will be accepted."},
	},
	"projects": {
		"add-collaborator": {
		...
		"remove-collaborator":          {"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag."},
		"review-user-permission-level": {"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag."},
		"update": {
			"body":                    "The description of the project.",
			"inertia-preview":         "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag.",
			"name":                    "The name of the project.",
	...
	"reactions": {
		...
		"delete-for-team-discussion":         {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
		"delete-for-team-discussion-comment": {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
	...
	"repos": {
		...
		"add-protected-branch-admin-enforcement": {"repo": "repository in OWNER/REPO form"},
		"add-protected-branch-app-restrictions":  {"repo": "repository in OWNER/REPO form"},
		...
		"add-protected-branch-required-status-checks-contexts": {"repo": "repository in OWNER/REPO form"},
		"add-protected-branch-team-restrictions":               {"repo": "repository in OWNER/REPO form"},
		"add-protected-branch-user-restrictions":               {"repo": "repository in OWNER/REPO form"},
		...
		"delete-download":       {"repo": "repository in OWNER/REPO form"},
		"delete-file": {
			"author.email":    "The email of the author (or committer) of the commit",
			"author.name":     "The name of the author (or committer) of the commit",
			"branch":          "The branch name. Default: the repository’s default branch (usually `master`)",
		...
		"delete-hook":          {"repo": "repository in OWNER/REPO form"},
		...
		"get-archive-link":                         {"repo": "repository in OWNER/REPO form"},
		...
		"get-download":                           {"repo": "repository in OWNER/REPO form"},
		"get-hook":                               {"repo": "repository in OWNER/REPO form"},
		...
		"get-protected-branch-admin-enforcement": {"repo": "repository in OWNER/REPO form"},
		...
		"get-protected-branch-required-status-checks": {"repo": "repository in OWNER/REPO form"},
		"get-protected-branch-restrictions":           {"repo": "repository in OWNER/REPO form"},
		...
		"list-protected-branch-required-status-checks-contexts": {"repo": "repository in OWNER/REPO form"},
		...
		"ping-hook":                                               {"repo": "repository in OWNER/REPO form"},
		"remove-branch-protection":                                {"repo": "repository in OWNER/REPO form"},
		"remove-collaborator":                                     {"repo": "repository in OWNER/REPO form"},
		"remove-deploy-key":                                       {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-admin-enforcement":               {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-app-restrictions":                {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-pull-request-review-enforcement": {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-required-signatures": {
			"repo":          "repository in OWNER/REPO form",
			"zzzax-preview": "Protected Branches API can now manage a setting for requiring signed commits. This feature is currently available for developers to preview. See the [blog post](https://developer.github.com/changes/2018-02-22-protected-branches-required-signatures) for full details. To access the API during the preview period, you must set this flag.",
		},
		"remove-protected-branch-required-status-checks":          {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-required-status-checks-contexts": {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-restrictions":                    {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-team-restrictions":               {"repo": "repository in OWNER/REPO form"},
		"remove-protected-branch-user-restrictions":               {"repo": "repository in OWNER/REPO form"},
		"replace-all-topics": {
			"mercy-preview": "The `topics` property for repositories on GitHub is currently available for developers to preview. To view the `topics` property in calls that return repository results, you must set this flag.",
		...
		"replace-protected-branch-app-restrictions":                {"repo": "repository in OWNER/REPO form"},
		"replace-protected-branch-required-status-checks-contexts": {"repo": "repository in OWNER/REPO form"},
		"replace-protected-branch-team-restrictions":               {"repo": "repository in OWNER/REPO form"},
		"replace-protected-branch-user-restrictions":               {"repo": "repository in OWNER/REPO form"},
		"request-page-build":                                       {"repo": "repository in OWNER/REPO form"},
		"retrieve-community-profile-metrics":                       {"repo": "repository in OWNER/REPO form"},
		"test-push-hook":                                           {"repo": "repository in OWNER/REPO form"},
		"transfer": {
	...
	"teams": {
		"add-or-update-membership-in-org": {"role": "The role that this user should have in the team. Can be one of:  \n\\* `member` - a normal member of the team.  \n\\* `maintainer` - a team maintainer. Able to add/remove other team members, promote other team members to team maintainer, and edit the team's name and description."},
		"add-or-update-membership-legacy": {"role": "The role that this user should have in the team. Can be one of:  \n\\* `member` - a normal member of the team.  \n\\* `maintainer` - a team maintainer. Able to add/remove other team members, promote other team members to team maintainer, and edit the team's name and description."},
		...
		"check-manages-repo-in-org": {"repo": "repository in OWNER/REPO form"},
		"check-manages-repo-legacy": {"repo": "repository in OWNER/REPO form"},
		"create": {
		...
		"get-discussion-comment-in-org":                  {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
		...
		"get-discussion-in-org":                          {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
		...
		"review-project-in-org": {"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag."},
		"review-project-legacy": {"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag."},
	...
	"users": {
		"add-emails":     {"emails": "Adds one or more email addresses to your GitHub account. Must contain at least one email address. **Note:** Alternatively, you can pass a single email address or an `array` of emails addresses directly, but we recommend that you pass an object using the `emails` key."},
		"create-gpg-key": {"armored_public_key": "Your GPG key, generated in ASCII-armored format. See \"[Generating a new GPG key](https://help.github.com/articles/generating-a-new-gpg-key/)\" for help creating a GPG key."},
		"create-public-key": {
		...
		"delete-emails": {"emails": "Deletes one or more email addresses from your GitHub account. Must contain at least one email address. **Note:** Alternatively, you can pass a single email address or an `array` of emails addresses directly, but we recommend that you pass an object using the `emails` key."},
