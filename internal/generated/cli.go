...
var FlagHelps = map[string]map[string]map[string]string{
	"actions": {
		...
		"delete-self-hosted-runner-from-org": {"runner_id": "runner_id parameter"},
		...
		"get-self-hosted-runner-for-org": {"runner_id": "runner_id parameter"},
	...
	"apps": {
		...
		"create-from-manifest": {"code": "code parameter"},
	...
	"gitignore": {"get-template": {"name": "name parameter"}},
	"interactions": {
	...
	"orgs": {
		...
		"remove-saml-sso-authorization": {"credential_id": "credential_id parameter"},
	...
	"users": {
		"check-following-for-user":         {"target_user": "target_user parameter"},
