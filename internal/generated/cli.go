...
var FlagHelps = map[string]map[string]map[string]string{
	"actions": {
		...
		"create-registration-token-for-org":  {"org": "org parameter"},
		"create-registration-token-for-repo": {"repo": "repository in OWNER/REPO form"},
		"create-remove-token-for-org":        {"org": "org parameter"},
		...
		"get-public-key": {"repo": "repository in OWNER/REPO form"},
		"get-secret": {
			"name": "name parameter",
			"repo": "repository in OWNER/REPO form",
		},
		...
		"list-runner-applications-for-org":  {"org": "org parameter"},
	...
	"activity": {
		...
		"check-watching-repo-legacy":                     {"repo": "repository in OWNER/REPO form"},
		...
		"stop-watching-repo-legacy":          {"repo": "repository in OWNER/REPO form"},
		"unstar-repo-for-authenticated-user": {"repo": "repository in OWNER/REPO form"},
		"watch-repo-legacy":                  {"repo": "repository in OWNER/REPO form"},
	},
	"apps": {
	...
	"orgs": {
		...
		"get-membership-for-authenticated-user": {"org": "org parameter"},
		"list":                                  {"since": "The integer ID of the last organization that you've seen."},
		"list-blocked-users":                    {"org": "org parameter"},
		"list-credential-authorizations":        {"org": "org parameter"},
		"list-for-authenticated-user": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
		},
	...
	"scim": {
		...
		"provision-and-invite-users": {"org": "org parameter"},
	...
	"search": {
		...
		"email-legacy": {"email": "The email address."},
	...
	"teams": {
		...
		"delete-legacy": {"team_id": "team_id parameter"},
		"get-by-name": {
			"org":       "org parameter",
			"team_slug": "team_slug parameter",
		},
		...
		"get-legacy": {"team_id": "team_id parameter"},
		"get-member-legacy": {
			"team_id":  "team_id parameter",
			"username": "username parameter",
		},
		...
		"list-id-p-groups-for-legacy": {"team_id": "team_id parameter"},
	...
	"users": {
		...
		"block":           {"username": "username parameter"},
		"check-blocked":   {"username": "username parameter"},
		"check-following": {"username": "username parameter"},
		...
		"delete-gpg-key":    {"gpg_key_id": "gpg_key_id parameter"},
		"delete-public-key": {"key_id": "key_id parameter"},
		"follow":            {"username": "username parameter"},
		"get-by-username":   {"username": "username parameter"},
		...
		"get-gpg-key":    {"gpg_key_id": "gpg_key_id parameter"},
		"get-public-key": {"key_id": "key_id parameter"},
		...
		"unblock":  {"username": "username parameter"},
		"unfollow": {"username": "username parameter"},
