...
var FlagHelps = map[string]map[string]map[string]string{
	...
	"billing": {
		"get-github-actions-billing-ghe":  {"enterprise": "Unique identifier of the GitHub Enterprise Cloud instance."},
		"get-github-packages-billing-ghe": {"enterprise": "Unique identifier of the GitHub Enterprise Cloud instance."},
		"get-shared-storage-billing-ghe":  {"enterprise": "Unique identifier of the GitHub Enterprise Cloud instance."},
	},
	"checks": {
		"create": {
	...
	"enterprise-admin": {
		"add-org-access-to-self-hosted-runner-group-in-enterprise": {
			"enterprise":      "Unique identifier of the GitHub Enterprise Cloud instance.",
		...
		"create-registration-token-for-enterprise": {"enterprise": "Unique identifier of the GitHub Enterprise Cloud instance."},
		"create-remove-token-for-enterprise":       {"enterprise": "Unique identifier of the GitHub Enterprise Cloud instance."},
		...
		"list-runner-applications-for-enterprise": {"enterprise": "Unique identifier of the GitHub Enterprise Cloud instance."},
