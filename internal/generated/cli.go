...
type CLI struct {
	...
	EnterpriseAdmin     EnterpriseAdminCmd     `cmd:""`
	Gists               GistsCmd               `cmd:""`
	Git                 GitCmd                 `cmd:""`
...
var CmdHelps = map[string]map[string]string{
	"actions": {
		"add-repo-access-to-self-hosted-runner-group-in-org":             "Add repository access to a self-hosted runner group in an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#add-repository-acess-to-a-self-hosted-runner-group-in-an-organization",
		...
		"add-self-hosted-runner-to-group-for-org":                        "Add a self-hosted runner to a group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#add-a-self-hosted-runner-to-a-group-for-an-organization",
		...
		"create-self-hosted-runner-group-for-org":                        "Create a self-hosted runner group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#create-a-self-hosted-runner-group-for-an-organization",
		...
		"delete-self-hosted-runner-group-from-org":                       "Delete a self-hosted runner group from an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#delete-a-self-hosted-runner-group-from-an-organization",
		...
		"disable-selected-repository-github-actions-organization":        "Disable a selected repository for GitHub Actions in an organization - https://developer.github.com/rest/reference/actions#disable-a-selected-repository-for-github-actions-in-an-organization",
		"disable-workflow":                                               "Disable a workflow - https://developer.github.com/v3/actions/workflows/#disable-a-workflow",
		...
		"enable-selected-repository-github-actions-organization":         "Enable a selected repository for GitHub Actions in an organization - https://developer.github.com/rest/reference/actions#enable-a-selected-repository-for-github-actions-in-an-organization",
		"enable-workflow":                                                "Enable a workflow - https://developer.github.com/v3/actions/workflows/#enable-a-workflow",
		"get-allowed-actions-organization":                               "Get allowed actions for an organization - https://developer.github.com/rest/reference/actions#get-allowed-actions-for-an-organization",
		"get-allowed-actions-repository":                                 "Get allowed actions for a repository - https://developer.github.com/rest/reference/actions#get-allowed-actions-for-a-repository",
		"get-artifact":                                                   "Get an artifact - https://developer.github.com/v3/actions/artifacts/#get-an-artifact",
		"get-github-actions-permissions-organization":                    "Get GitHub Actions permissions for an organization - https://developer.github.com/rest/reference/actions#get-github-actions-permissions-for-an-organization",
		"get-github-actions-permissions-repository":                      "Get GitHub Actions permissions for a repository - https://developer.github.com/rest/reference/actions#get-github-actions-permissions-for-a-repository",
		...
		"get-self-hosted-runner-group-for-org":                           "Get a self-hosted runner group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#get-a-self-hosted-runner-group-for-an-organization",
		...
		"list-repo-access-to-self-hosted-runner-group-in-org":            "List repository access to a self-hosted runner group in an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#list-repository-access-to-a-self-hosted-runner-group-in-an-organization",
		...
		"list-selected-repositories-enabled-github-actions-organization": "List selected repositories enabled for GitHub Actions in an organization - https://developer.github.com/rest/reference/actions#list-selected-repositories-enabled-for-github-actions-in-an-organization",
		"list-self-hosted-runner-groups-for-org":                         "List self-hosted runner groups for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#list-self-hosted-runner-groups-for-an-organization",
		...
		"list-self-hosted-runners-in-group-for-org":                      "List self-hosted runners in a group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#list-self-hosted-runners-in-a-group-for-an-organization",
		...
		"remove-repo-access-to-self-hosted-runner-group-in-org":          "Remove repository access to a self-hosted runner group in an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#remove-repository-access-to-a-self-hosted-runner-group-in-an-organization",
		...
		"remove-self-hosted-runner-from-group-for-org":                   "Remove a self-hosted runner from a group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#remove-a-self-hosted-runner-from-a-group-for-an-organization",
		"set-allowed-actions-organization":                               "Set allowed actions for an organization - https://developer.github.com/rest/reference/actions#set-allowed-actions-for-an-organization",
		"set-allowed-actions-repository":                                 "Set allowed actions for a repository - https://developer.github.com/rest/reference/actions#set-allowed-actions-for-a-repository",
		"set-github-actions-permissions-organization":                    "Set GitHub Actions permissions for an organization - https://developer.github.com/rest/reference/actions#set-github-actions-permissions-for-an-organization",
		"set-github-actions-permissions-repository":                      "Set GitHub Actions permissions for a repository - https://developer.github.com/rest/reference/actions#set-github-actions-permissions-for-a-repository",
		"set-repo-access-to-self-hosted-runner-group-in-org":             "Set repository access for a self-hosted runner group in an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#set-repository-access-to-a-self-hosted-runner-group-in-an-organization",
		...
		"set-selected-repositories-enabled-github-actions-organization":  "Set selected repositories enabled for GitHub Actions in an organization - https://developer.github.com/rest/reference/actions#set-selected-repositories-enabled-for-github-actions-in-an-organization",
		"set-self-hosted-runners-in-group-for-org":                       "Set self-hosted runners in a group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#set-self-hosted-runners-in-a-group-for-an-organization",
		"update-self-hosted-runner-group-for-org":                        "Update a self-hosted runner group for an organization - https://developer.github.com/v3/actions/self-hosted-runner-groups/#update-a-self-hosted-runner-group-for-an-organization",
	},
	"activity": {
	...
	"code-scanning": {
		...
		"list-recent-analyses": "List recent code scanning analyses for a repository - https://developer.github.com/v3/code-scanning/#list-recent-analyses",
		"update-alert":         "Update a code scanning alert - https://developer.github.com/v3/code-scanning/#upload-a-code-scanning-alert",
		"upload-sarif":         "Upload a SARIF file - https://developer.github.com/v3/code-scanning/#upload-a-sarif-analysis",
	},
	"codes-of-conduct": {
	...
	"enterprise-admin": {
		"add-org-access-to-self-hosted-runner-group-in-enterprise":      "Add organization access to a self-hosted runner group in an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#add-organization-access-to-a-self-hosted-runner-group-in-an-enterprise",
		"add-self-hosted-runner-to-group-for-enterprise":                "Add a self-hosted runner to a group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#add-a-self-hosted-runner-to-a-group-for-an-enterprise",
		"create-registration-token-for-enterprise":                      "Create a registration token for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#create-a-registration-token-for-an-enterprise",
		"create-remove-token-for-enterprise":                            "Create a remove token for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#create-a-remove-token-for-an-enterprise",
		"create-self-hosted-runner-group-for-enterprise":                "Create a self-hosted runner group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#create-self-hosted-runner-group-for-an-enterprise",
		"delete-scim-group-from-enterprise":                             "Delete a SCIM group from an enterprise - https://developer.github.com/v3/enterprise-admin/scim/#delete-a-scim-group-from-an-enterprise",
		"delete-self-hosted-runner-from-enterprise":                     "Delete a self-hosted runner from an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#delete-self-hosted-runner-from-an-enterprise",
		"delete-self-hosted-runner-group-from-enterprise":               "Delete a self-hosted runner group from an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#delete-a-self-hosted-runner-group-from-an-enterprise",
		"delete-user-from-enterprise":                                   "Delete a SCIM user from an enterprise - https://developer.github.com/v3/enterprise-admin/scim/#delete-a-scim-user-from-an-enterprise",
		"disable-selected-organization-github-actions-enterprise":       "Disable a selected organization for GitHub Actions in an enterprise - https://developer.github.com/rest/reference/enterprise-admin#disable-a-selected-organization-for-github-actions-in-an-enterprise",
		"enable-selected-organization-github-actions-enterprise":        "Enable a selected organization for GitHub Actions in an enterprise - https://developer.github.com/rest/reference/enterprise-admin#enable-a-selected-organization-for-github-actions-in-an-enterprise",
		"get-allowed-actions-enterprise":                                "Get allowed actions for an enterprise - https://developer.github.com/rest/reference/enterprise-admin#get-allowed-actions-for-an-enterprise",
		"get-github-actions-permissions-enterprise":                     "Get GitHub Actions permissions for an enterprise - https://developer.github.com/rest/reference/enterprise-admin#get-github-actions-permissions-for-an-enterprise",
		"get-provisioning-information-for-enterprise-group":             "Get SCIM provisioning information for an enterprise group - https://developer.github.com/v3/enterprise-admin/scim/#get-scim-provisioning-information-for-an-enterprise group",
		"get-provisioning-information-for-enterprise-user":              "Get SCIM provisioning information for an enterprise user - https://developer.github.com/v3/enterprise-admin/scim/#get-scim-provisioning-information-for-an-enterprise-user",
		"get-self-hosted-runner-for-enterprise":                         "Get a self-hosted runner for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#get-a-self-hosted-runner-for-an-enterprise",
		"get-self-hosted-runner-group-for-enterprise":                   "Get a self-hosted runner group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#get-a-self-hosted-runner-group-for-an-enterprise",
		"list-org-access-to-self-hosted-runner-group-in-enterprise":     "List organization access to a self-hosted runner group in an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#list-organization-access-to-a-self-hosted-runner-group-in-a-enterprise",
		"list-provisioned-groups-enterprise":                            "List provisioned SCIM groups for an enterprise - https://developer.github.com/v3/enterprise-admin/scim/#list-provisioned-scim groups-for-an-enterprise",
		"list-provisioned-identities-enterprise":                        "List SCIM provisioned identities for an enterprise - https://developer.github.com/v3/enterprise-admin/scim/#list-scim-provisioned-identities-for-an-enterprise",
		"list-runner-applications-for-enterprise":                       "List runner applications for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#list-runner-applications-for-an-enterprise",
		"list-selected-organizations-enabled-github-actions-enterprise": "List selected organizations enabled for GitHub Actions in an enterprise - https://developer.github.com/rest/reference/enterprise-admin#list-selected-organizations-enabled-for-github-actions-in-an-enterprise",
		"list-self-hosted-runner-groups-for-enterprise":                 "List self-hosted runner groups for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#list-self-hosted-runner-groups-for-an-enterprise",
		"list-self-hosted-runners-for-enterprise":                       "List self-hosted runners for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#list-self-hosted-runners-for-an-enterprise",
		"list-self-hosted-runners-in-group-for-enterprise":              "List self-hosted runners in a group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#list-self-hosted-runners-in-a-group-for-an-enterprise",
		"provision-and-invite-enterprise-group":                         "Provision a SCIM enterprise group and invite users - https://developer.github.com/v3/enterprise-admin/scim/#provision-a-scim-enterprise-group-and-invite-users",
		"provision-and-invite-enterprise-user":                          "Provision and invite a SCIM enterprise user - https://developer.github.com/v3/enterprise-admin/scim/#provision-and-invite-a-scim-enterprise-user",
		"remove-org-access-to-self-hosted-runner-group-in-enterprise":   "Remove organization access to a self-hosted runner group in an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#remove-organization-access-to-a-self-hosted-runner-group-in-an-enterprise",
		"remove-self-hosted-runner-from-group-for-enterprise":           "Remove a self-hosted runner from a group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#remove-a-self-hosted-runner-from-a-group-for-an-enterprise",
		"set-allowed-actions-enterprise":                                "Set allowed actions for an enterprise - https://developer.github.com/rest/reference/enterprise-admin#set-allowed-actions-for-an-enterprise",
		"set-github-actions-permissions-enterprise":                     "Set GitHub Actions permissions for an enterprise - https://developer.github.com/rest/reference/enterprise-admin#set-github-actions-permissions-for-an-enterprise",
		"set-information-for-provisioned-enterprise-group":              "Set SCIM information for a provisioned enterprise group - https://developer.github.com/v3/enterprise-admin/scim/#set-scim-information-for-a-provisioned-enterprise-group",
		"set-information-for-provisioned-enterprise-user":               "Set SCIM information for a provisioned enterprise user - https://developer.github.com/v3/enterprise-admin/scim/#set-scim-information-for-a-provisioned-enterprise-user",
		"set-org-access-to-self-hosted-runner-group-in-enterprise":      "Set organization access for a self-hosted runner group in an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#set-organization-access-to-a-self-hosted-runner-group-in-an-enterprise",
		"set-selected-organizations-enabled-github-actions-enterprise":  "Set selected organizations enabled for GitHub Actions in an enterprise - https://developer.github.com/rest/reference/enterprise-admin#set-selected-organizations-enabled-for-github-actions-in-an-enterprise",
		"set-self-hosted-runners-in-group-for-enterprise":               "Set self-hosted runners in a group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#set-self-hosted-runners-in-a-group-for-an-enterprise",
		"update-attribute-for-enterprise-group":                         "Update an attribute for a SCIM enterprise group - https://developer.github.com/v3/enterprise-admin/scim/#update-an-attribute-for-a-scim-enterprise-group",
		"update-attribute-for-enterprise-user":                          "Update an attribute for a SCIM enterprise user - https://developer.github.com/v3/enterprise-admin/scim/#update-an-attribute-for-a-scim-enterprise-user",
		"update-self-hosted-runner-group-for-enterprise":                "Update a self-hosted runner group for an enterprise - https://developer.github.com/v3/enterprise-admin/actions/#update-a-self-hosted-runner-group-for-an-enterprise",
	},
	"gists": {
	...
	"meta": {
		"get":         "Get GitHub meta information - https://developer.github.com/v3/meta/#get-github-meta-information",
	...
	"projects": {
		...
		"remove-collaborator":           "Remove user as a collaborator - https://developer.github.com/v3/projects/collaborators/#remove-project-collaborator",
		"update":                        "Update a project - https://developer.github.com/v3/projects/#update-a-project",
		"update-card":                   "Update an existing project card - https://developer.github.com/v3/projects/cards/#update-a-project-card",
		"update-column":                 "Update an existing project column - https://developer.github.com/v3/projects/columns/#update-a-project-column",
	},
	"pulls": {
	...
	"repos": {
		...
		"download-tarball-archive":                  "Download a repository archive (tar) - https://developer.github.com/v3/repos/contents/#download-a-repository-archive",
		"download-zipball-archive":                  "Download a repository archive (zip) - https://developer.github.com/v3/repos/contents/#download-a-repository-archive",
		...
		"update-status-check-protection":            "Update status check protection - https://developer.github.com/v3/repos/branches/#update-status-check-potection",
	...
	"scim": {
		...
		"set-information-for-provisioned-user":  "Update a provisioned organization membership - https://developer.github.com/v3/scim/#set-scim-information-for-a-provisioned-user",
	...
	"teams": {
		...
		"create-or-update-idp-group-connections-in-org": "Create or update IdP group connections - https://developer.github.com/v3/teams/team_sync/#create-or-update-idp-group-connections",
		"create-or-update-idp-group-connections-legacy": "Create or update IdP group connections (Legacy) - https://developer.github.com/v3/teams/team_sync/#create-or-update-idp-group-connections-legacy",
		...
		"list-idp-groups-for-legacy":                    "List IdP groups for a team (Legacy) - https://developer.github.com/v3/teams/team_sync/#list-idp-groups-for-a-team-legacy",
		"list-idp-groups-for-org":                       "List IdP groups for an organization - https://developer.github.com/v3/teams/team_sync/#list-idp-groups-for-an-organization",
		"list-idp-groups-in-org":                        "List IdP groups for a team - https://developer.github.com/v3/teams/team_sync/#list-idp-groups-for-a-team",
...
var FlagHelps = map[string]map[string]map[string]string{
	"actions": {
		"add-repo-access-to-self-hosted-runner-group-in-org": {"runner_group_id": "Unique identifier of the self-hosted runner group."},
		"add-selected-repo-to-org-secret":                    {"secret_name": "secret_name parameter"},
		"add-self-hosted-runner-to-group-for-org": {
		...
		"create-self-hosted-runner-group-for-org": {
		...
		"delete-org-secret": {"secret_name": "secret_name parameter"},
		"delete-repo-secret": {
			"repo":        "repository in OWNER/REPO form",
			"secret_name": "secret_name parameter",
		},
		"delete-self-hosted-runner-from-org": {"runner_id": "Unique identifier of the self-hosted runner."},
		"delete-self-hosted-runner-from-repo": {
			"repo":      "repository in OWNER/REPO form",
			"runner_id": "Unique identifier of the self-hosted runner.",
		},
		"delete-self-hosted-runner-group-from-org": {"runner_group_id": "Unique identifier of the self-hosted runner group."},
		...
		"get-allowed-actions-repository": {"repo": "repository in OWNER/REPO form"},
		"get-artifact": {
			"artifact_id": "artifact_id parameter",
			"repo":        "repository in OWNER/REPO form",
		},
		"get-github-actions-permissions-repository": {"repo": "repository in OWNER/REPO form"},
		"get-job-for-workflow-run": {
			"job_id": "job_id parameter",
			"repo":   "repository in OWNER/REPO form",
		},
		"get-org-secret":      {"secret_name": "secret_name parameter"},
		"get-repo-public-key": {"repo": "repository in OWNER/REPO form"},
		"get-repo-secret": {
			"repo":        "repository in OWNER/REPO form",
			"secret_name": "secret_name parameter",
		},
		"get-self-hosted-runner-for-org": {"runner_id": "Unique identifier of the self-hosted runner."},
		"get-self-hosted-runner-for-repo": {
			"repo":      "repository in OWNER/REPO form",
			"runner_id": "Unique identifier of the self-hosted runner.",
		},
		"get-self-hosted-runner-group-for-org": {"runner_group_id": "Unique identifier of the self-hosted runner group."},
		"get-workflow": {
			"repo":        "repository in OWNER/REPO form",
			"workflow_id": "The ID of the workflow. You can also pass the workflow file name as a string.",
		},
		...
		"list-repo-access-to-self-hosted-runner-group-in-org": {"runner_group_id": "Unique identifier of the self-hosted runner group."},
		"list-repo-secrets": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
			"repo":     "repository in OWNER/REPO form",
		...
		"list-selected-repos-for-org-secret": {"secret_name": "secret_name parameter"},
		"list-selected-repositories-enabled-github-actions-organization": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
		},
		"list-self-hosted-runner-groups-for-org": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
		},
		...
		"list-self-hosted-runners-in-group-for-org": {
			"page":            "Page number of the results to fetch.",
			"per_page":        "Results per page (max 100)",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
		},
		...
		"remove-repo-access-to-self-hosted-runner-group-in-org": {"runner_group_id": "Unique identifier of the self-hosted runner group."},
		"remove-selected-repo-from-org-secret":                  {"secret_name": "secret_name parameter"},
		"remove-self-hosted-runner-from-group-for-org": {
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
			"runner_id":       "Unique identifier of the self-hosted runner.",
		},
		"set-allowed-actions-organization": {
		...
		"set-repo-access-to-self-hosted-runner-group-in-org": {
			"runner_group_id":         "Unique identifier of the self-hosted runner group.",
			"selected_repository_ids": "List of repository IDs that can access the runner group.",
		},
		...
		"set-selected-repositories-enabled-github-actions-organization": {"selected_repository_ids": "List of repository IDs to enable for GitHub Actions."},
		"set-self-hosted-runners-in-group-for-org": {
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
			"runners":         "List of runner IDs to add to the runner group.",
		},
		"update-self-hosted-runner-group-for-org": {
			"name":            "Name of the runner group.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
	...
	"activity": {
		...
		"delete-thread-subscription":                     {"thread_id": "thread_id parameter"},
		"get-repo-subscription":                          {"repo": "repository in OWNER/REPO form"},
		"get-thread":                                     {"thread_id": "thread_id parameter"},
		"get-thread-subscription-for-authenticated-user": {"thread_id": "thread_id parameter"},
		...
		"mark-thread-as-read": {"thread_id": "thread_id parameter"},
	...
	"apps": {
		"add-repo-to-installation": {"installation_id": "installation_id parameter"},
		"check-token":              {"access_token": "The access_token of the OAuth application."},
		...
		"delete-installation":                       {"installation_id": "installation_id parameter"},
		"delete-token":                              {"access_token": "The OAuth access token used to authenticate to the GitHub API."},
		"get-installation":                          {"installation_id": "installation_id parameter"},
		"get-repo-installation":                     {"repo": "repository in OWNER/REPO form"},
		"get-subscription-plan-for-account":         {"account_id": "account_id parameter"},
		"get-subscription-plan-for-account-stubbed": {"account_id": "account_id parameter"},
		...
		"remove-repo-from-installation": {"installation_id": "installation_id parameter"},
		"reset-token":                   {"access_token": "The access_token of the OAuth application."},
		"suspend-installation":          {"installation_id": "installation_id parameter"},
		"unsuspend-installation":        {"installation_id": "installation_id parameter"},
	},
	"billing": {
		"get-github-actions-billing-ghe":  {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"get-github-packages-billing-ghe": {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"get-shared-storage-billing-ghe":  {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
	},
	"checks": {
		"create": {
	...
	"code-scanning": {
		...
		"update-alert": {
			"alert_number":     "The code scanning alert number.",
		...
		"upload-sarif": {
			...
			"commit_sha":   "The commit SHA of the code scanning analysis file.",
			"ref":          "The full Git reference of the code scanning analysis file, formatted as `refs/heads/<branch name>`.",
			"repo":         "repository in OWNER/REPO form",
			"sarif":        "A Base64 string representing the SARIF file to upload. You must first compress your SARIF file using [`gzip`](http://www.gnu.org/software/gzip/manual/gzip.html) and then translate the contents of the file into a Base64 encoding string.",
			...
			"tool_name":    "The name of the tool used to generate the code scanning analysis alert.",
		},
	},
	"codes-of-conduct": {
	...
	"enterprise-admin": {
		"add-org-access-to-self-hosted-runner-group-in-enterprise": {
		...
		"add-self-hosted-runner-to-group-for-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
			"runner_id":       "Unique identifier of the self-hosted runner.",
		},
		"create-registration-token-for-enterprise": {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"create-remove-token-for-enterprise":       {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"create-self-hosted-runner-group-for-enterprise": {
			"enterprise":                "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"name":                      "Name of the runner group.",
			"runners":                   "List of runner IDs to add to the runner group.",
		...
		"delete-scim-group-from-enterprise": {
			"enterprise":    "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"scim_group_id": "Identifier generated by the GitHub SCIM endpoint.",
		},
		"delete-self-hosted-runner-from-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_id":  "Unique identifier of the self-hosted runner.",
		},
		"delete-self-hosted-runner-group-from-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
		},
		...
		"disable-selected-organization-github-actions-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"org_id":     "Unique identifier of an organization.",
		},
		"enable-selected-organization-github-actions-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"org_id":     "Unique identifier of an organization.",
		},
		"get-allowed-actions-enterprise":            {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"get-github-actions-permissions-enterprise": {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"get-provisioning-information-for-enterprise-group": {
			"enterprise":    "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"scim_group_id": "Identifier generated by the GitHub SCIM endpoint.",
		},
		"get-provisioning-information-for-enterprise-user": {
			"enterprise":   "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"scim_user_id": "scim_user_id parameter",
		},
		"get-self-hosted-runner-for-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_id":  "Unique identifier of the self-hosted runner.",
		},
		"get-self-hosted-runner-group-for-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
		},
		"list-org-access-to-self-hosted-runner-group-in-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"page":            "Page number of the results to fetch.",
			"per_page":        "Results per page (max 100)",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
		},
		"list-provisioned-groups-enterprise": {
		...
		"list-provisioned-identities-enterprise": {
			"count":      "Used for pagination: the number of results to return.",
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"startIndex": "Used for pagination: the index of the first result to return.",
		},
		"list-runner-applications-for-enterprise": {"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id."},
		"list-selected-organizations-enabled-github-actions-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"page":       "Page number of the results to fetch.",
			"per_page":   "Results per page (max 100)",
		},
		"list-self-hosted-runner-groups-for-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"page":       "Page number of the results to fetch.",
			"per_page":   "Results per page (max 100)",
		},
		"list-self-hosted-runners-for-enterprise": {
			"enterprise": "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"page":       "Page number of the results to fetch.",
			"per_page":   "Results per page (max 100)",
		},
		"list-self-hosted-runners-in-group-for-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"page":            "Page number of the results to fetch.",
			"per_page":        "Results per page (max 100)",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
		},
		"provision-and-invite-enterprise-group": {
		...
		"provision-and-invite-enterprise-user": {
		...
		"remove-org-access-to-self-hosted-runner-group-in-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"org_id":          "Unique identifier of an organization.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
		},
		"remove-self-hosted-runner-from-group-for-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
			"runner_id":       "Unique identifier of the self-hosted runner.",
		},
		"set-allowed-actions-enterprise": {
			"enterprise":           "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"github_owned_allowed": "Whether GitHub-owned actions are allowed. For example, this includes the actions in the `actions` organization.",
			"patterns_allowed":     "Specifies a list of string-matching patterns to allow specific action(s). Wildcards, tags, and SHAs are allowed. For example, `monalisa/octocat@*`, `monalisa/octocat@v2`, `monalisa/*`.\"",
			"verified_allowed":     "Whether actions in GitHub Marketplace from verified creators are allowed. Set to `true` to allow all GitHub Marketplace actions by verified creators.",
		},
		"set-github-actions-permissions-enterprise": {
			"allowed_actions":       "The permissions policy that controls the actions that are allowed to run. Can be one of: `all`, `local_only`, or `selected`.",
		...
		"set-information-for-provisioned-enterprise-group": {
			"displayName":   "The name of the SCIM group. This must match the GitHub organization that the group maps to.",
			"enterprise":    "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"schemas":       "The SCIM schema URIs.",
			"scim_group_id": "Identifier generated by the GitHub SCIM endpoint.",
		},
		"set-information-for-provisioned-enterprise-user": {
			"emails":          "List of user emails.",
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"groups":          "List of SCIM group IDs the user is a member of.",
			"name.familyName": "The last name of the user.",
		...
		"set-org-access-to-self-hosted-runner-group-in-enterprise": {
			"enterprise":                "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_group_id":           "Unique identifier of the self-hosted runner group.",
			"selected_organization_ids": "List of organization IDs that can access the runner group.",
		},
		"set-selected-organizations-enabled-github-actions-enterprise": {
			"enterprise":                "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"selected_organization_ids": "List of organization IDs to enable for GitHub Actions.",
		},
		"set-self-hosted-runners-in-group-for-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
			"runners":         "List of runner IDs to add to the runner group.",
		},
		"update-attribute-for-enterprise-group": {
			"Operations":    "Array of [SCIM operations](https://tools.ietf.org/html/rfc7644#section-3.5.2).",
			"enterprise":    "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"schemas":       "The SCIM schema URIs.",
			"scim_group_id": "Identifier generated by the GitHub SCIM endpoint.",
		},
		"update-attribute-for-enterprise-user": {
			"Operations":   "Array of [SCIM operations](https://tools.ietf.org/html/rfc7644#section-3.5.2).",
			"enterprise":   "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"schemas":      "The SCIM schema URIs.",
			"scim_user_id": "scim_user_id parameter",
		},
		"update-self-hosted-runner-group-for-enterprise": {
			"enterprise":      "The slug version of the enterprise name. You can also substitute this value with the enterprise id.",
			"name":            "Name of the runner group.",
			"runner_group_id": "Unique identifier of the self-hosted runner group.",
	...
	"gists": {
		"check-is-starred": {"gist_id": "gist_id parameter"},
		"create": {
		...
		"delete": {"gist_id": "gist_id parameter"},
		"delete-comment": {
			"comment_id": "comment_id parameter",
			"gist_id":    "gist_id parameter",
		},
		"fork": {"gist_id": "gist_id parameter"},
		"get":  {"gist_id": "gist_id parameter"},
		"get-comment": {
			"comment_id": "comment_id parameter",
			"gist_id":    "gist_id parameter",
		},
		"get-revision": {"gist_id": "gist_id parameter"},
		"list": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
			"since":    "Only show notifications updated after the given time. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: `YYYY-MM-DDTHH:MM:SSZ`.",
		...
		"star":   {"gist_id": "gist_id parameter"},
		"unstar": {"gist_id": "gist_id parameter"},
		"update": {
			"description": "Description of the gist",
	...
	"licenses": {
		"get-all-commonly-used": {"per_page": "Results per page (max 100)"},
		"get-for-repo":          {"repo": "repository in OWNER/REPO form"},
	},
	"markdown": {
		"render": {
	...
	"meta": {"get-octocat": {"s": "The words to show in Octocat's speech bubble"}},
	"migrations": {
	...
	"oauth-authorizations": {
		...
		"delete-authorization": {"authorization_id": "authorization_id parameter"},
		"delete-grant":         {"grant_id": "grant_id parameter"},
		"get-authorization":    {"authorization_id": "authorization_id parameter"},
		"get-grant":            {"grant_id": "grant_id parameter"},
	...
	"projects": {
		...
		"move-card": {
			...
			"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag.",
			"position":        "The position of the card in a column",
		},
		"move-column": {
			"column_id":       "column_id parameter",
			"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag.",
	...
	"pulls": {
		...
		"get": {"repo": "repository in OWNER/REPO form"},
		"get-review": {
			"repo":      "repository in OWNER/REPO form",
			"review_id": "review_id parameter",
		},
	...
	"reactions": {
		...
		"delete-legacy": {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
	...
	"repos": {
		"accept-invitation": {"invitation_id": "invitation_id parameter"},
		...
		"create-pages-site": {
			"repo":               "repository in OWNER/REPO form",
			"source.branch":      "The repository branch used to publish your site's source files.",
		...
		"decline-invitation": {"invitation_id": "invitation_id parameter"},
		...
		"download-tarball-archive": {"repo": "repository in OWNER/REPO form"},
		"download-zipball-archive": {"repo": "repository in OWNER/REPO form"},
		...
		"get-community-profile-metrics": {
			"black-panther-preview": "We're currently offering a preview of the Community Profile API (also known as community health). To access the API during the preview period, you must set this flag.",
			"repo":                  "repository in OWNER/REPO form",
		},
		"get-content": {
			"path": "path+ parameter",
	...
	"scim": {
		"delete-user-from-org":                  {"scim_user_id": "scim_user_id parameter"},
		"get-provisioning-information-for-user": {"scim_user_id": "scim_user_id parameter"},
	...
	"teams": {
		"add-or-update-membership-for-user-in-org": {
		...
		"check-permissions-for-project-in-org": {
			"inertia-preview": "The Projects API is currently available for developers to preview. During the preview period, the API may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-10-27-changes-to-projects-api) for full details. To access the API during the preview period, you must set this flag.",
			"team_slug":       "team_slug parameter",
		},
		...
		"check-permissions-for-repo-in-org": {
			"repo":      "repository in OWNER/REPO form",
			"team_slug": "team_slug parameter",
		},
		...
		"create-or-update-idp-group-connections-in-org": {
		...
		"create-or-update-idp-group-connections-legacy": {"groups": "The IdP groups you want to connect to a GitHub team. When updating, the new `groups` object will replace the original one. You must include any existing groups that you don't want to remove."},
		"delete-discussion-comment-in-org":              {"team_slug": "team_slug parameter"},
		"delete-discussion-in-org":                      {"team_slug": "team_slug parameter"},
		"delete-in-org":                                 {"team_slug": "team_slug parameter"},
		"get-by-name":                                   {"team_slug": "team_slug parameter"},
		"get-discussion-comment-in-org": {
			"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag.",
			"team_slug":             "team_slug parameter",
		},
		"get-discussion-comment-legacy": {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
		"get-discussion-in-org": {
			"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag.",
			"team_slug":             "team_slug parameter",
		},
		"get-discussion-legacy":          {"squirrel-girl-preview": "An additional `reactions` object in the issue comment payload is currently available for developers to preview. During the preview period, the APIs may change without advance notice. Please see the [blog post](https://developer.github.com/changes/2016-05-12-reactions-api-preview) for full details.\n\nTo access the API you must set this flag."},
		"get-membership-for-user-in-org": {"team_slug": "team_slug parameter"},
		"list": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
		},
		...
		"list-idp-groups-for-org": {
			"page":     "Page number of the results to fetch.",
			"per_page": "Results per page (max 100)",
		},
		"list-idp-groups-in-org": {"team_slug": "team_slug parameter"},
		"list-members-in-org": {
			"page":      "Page number of the results to fetch.",
			"per_page":  "Results per page (max 100)",
		...
		"remove-membership-for-user-in-org": {"team_slug": "team_slug parameter"},
		"remove-project-in-org":             {"team_slug": "team_slug parameter"},
		"remove-repo-in-org": {
			"repo":      "repository in OWNER/REPO form",
			"team_slug": "team_slug parameter",
		},
	...
	"users": {
		"create-gpg-key-for-authenticated": {"armored_public_key": "A GPG key in ASCII-armored format."},
		...
		"delete-gpg-key-for-authenticated":        {"gpg_key_id": "gpg_key_id parameter"},
		"delete-public-ssh-key-for-authenticated": {"key_id": "key_id parameter"},
		...
		"get-gpg-key-for-authenticated":        {"gpg_key_id": "gpg_key_id parameter"},
		"get-public-ssh-key-for-authenticated": {"key_id": "key_id parameter"},
		"list": {
			"per_page": "Results per page (max 100)",
			"since":    "Only show notifications updated after the given time. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: `YYYY-MM-DDTHH:MM:SSZ`.",
		},
		...
		"set-primary-email-visibility-for-authenticated": {
			"email":      "An email address associated with the GitHub user account to manage.",
			"visibility": "Denotes whether an email is publically visible.",
		},
